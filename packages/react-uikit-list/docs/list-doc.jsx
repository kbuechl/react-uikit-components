  ...
  render () {
    return <div>
      ...
      <section>
        <h2>Usage</h2>
        <p>
          <code>npm install react-uikit-list --save;</code>
        </p>
        <p>
          ES6 <br />
          <code>import List from 'react-uikit-list';</code><br />
          <code>import Listitem from 'react-uikit-list/lib/ListItem';</code>
        </p>

        <p>
          ES5 <br />
          <code>var List = require&#40;'react-uikit-list'&#41;;</code><br />
          <code>var Listitem = require&#40;'react-uikit-list/lib/ListItem'&#41;;</code>
        </p>
      ...
      <section>
        <h2>List types</h2>
        <p>
          List can be either unorderd or description.<br />
        List are unordered by default. To create a description
...
`}
      ...
      <section>
        ...
        <p>
          List items can be dynamicly created by setting
...
`}
      ...
      <section>
        <h2>List props</h2>
        <p>
          <code>&lt;List&gt;</code> props and their types.
        </p>
        <p>
        ...
        <Table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                oneOf<br />
                description or unorderd. Default is unorderd.
              </td>
            </tr>
      ...
      <section>
        ...
        <p>
          <code>&lt;ListItem&gt;</code> props and their types.
        </p>
        <p>
          See <a href='https://github.com/otissv/react-uikit-base'>base</a> for additional props.
        </p>
