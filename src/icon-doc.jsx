...
const IconsDoc = (props) => (
  <div>
    <section>
      ...
      <p>
        <a href='https://github.com/otissv/react-uikit-icons'>react-uikit-icons</a> on github.
      </p>
      </section>
...
var Icons = require('react-uikit-icons').default`}
      ...
      <p>
       The Icon component uses the fantastic <a href='https://fortawesome.github.io/Font-Awesome/'>Font Awesome</a> icon font, 
       a project by Dave Gandy, which provides more than 300 symbols and glyphs for web-related actions.
      </p>
      ...
      <Table caption=''>
        <tbody>
          <tr>
            <td><Icons kitid='i1' icon='cog' /></td>
            <td>Uses the <code>icon='cog'</code> prop</td>
          </tr>
          <tr>
            <td><Icons kitid='i1' icon='user' /></td>
            <td>Uses the <code>icon='user'</code> prop</td>
          </tr>
          <tr>
            <td><Icons kitid='i1' icon='home' /></td>
            <td>Uses the <code>icon='home'</code> prop</td>
          </tr>
       </tbody>
      </Table>
...
`}
    ...
    <section>
      <h2>Icons link</h2>
      <p>
        Icons can be used as anchors by adding the <code>link</code> prop.
        The properties from the <code>link</code> prop will be passed to the anchor.
      </p>
...
`}
    ...
    <section>
      <h2>Button icon</h2>
      <p>
        To display an Icon as a button add a <code>type: 'button'</code>  property to 
        the <code>link</code> prop.
      </p>
...
`}
    ...
    <section>
      <h2>Icons sizes</h2>
      <p>
        Icons can be displayed in larger sizes by using the <code>size='*'</code> prop.
      </p>
      ...
      <Table caption=''>
        <tbody>
          ...
          <tr>
            <td><Icons kitid='i1' icon='home' size='small'/></td>
            <td>Uses the <code>size='small'</code> prop</td>
          </tr>
          <tr>
            <td><Icons kitid='i1' icon='home' size='medium'/></td>
            <td>Uses the <code>size='medium'</code> prop</td>
          </tr>
          <tr>
            <td><Icons kitid='i1' icon='home' size='large'/></td>
            <td>Uses the <code>size='large'</code> prop</td>
          </tr>
       </tbody>
      </Table>
...
`}
    ...
    <section>
      <h2>Spinning Icon</h2>
      <p>
        Add the <code>spin</code> class to create animated spinning icons.
      </p>
...
`}
    ...
    <section>
      <h2>Justify icons</h2>
      <p>
        To add a fixed width to the icon and center it, add the <code>justify</code> prop. 
        This is useful when using different icons in a list.
      </p>

      <h3 className='example'>Example</h3>
      <List line>
        <ListItem>
          <Icons justify icon='flash' size='small' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='folder' size='small' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='plug' size='small' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='lock ' size='small' /> Justified icon
        </ListItem> 
      </List>
...
{`<List line>
  <ListItem>
    <Icons justify icon='flash' size='small' />
  </ListItem>
  <ListItem>
    <Icons justify icon='folder' size='small' />
  </ListItem>
  <ListItem>
    <Icons justify icon='plug' size='small' />
  </ListItem>
  <ListItem>
    <Icons justify icon='lock ' size='small' />
  </ListItem>
</List>
`}
      </Codeblock>
