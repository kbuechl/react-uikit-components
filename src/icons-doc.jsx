...
`}
    ...
    <section>
      ...
      <List line>
        <ListItem>
          <Icons justify icon='flash' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='folder' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='plug' /> Justified icon
        </ListItem>
        <ListItem>
          <Icons justify icon='lock' /> Justified icon
        </ListItem>
      </List>
...
{`<List line>
  <ListItem>
    <Icons justify icon='flash' />
  </ListItem>
  <ListItem>
    <Icons justify icon='folder' />
  </ListItem>
  <ListItem>
    <Icons justify icon='plug' />
  </ListItem>
  <ListItem>
    <Icons justify icon='lock' />
  </ListItem>
</List>
`}
      </Codeblock>
